...
def main():
    if len(sys.argv) < 5:
        print("Usage: python random_forest_titanic.py <train_path> <test_path> <output_path> <target> <feature1> [feature2] ...")
        sys.exit(1)
    ...
    print(f"Результаты Random Forest сохранены в: {output_path}")
